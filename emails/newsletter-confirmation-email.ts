...
<head>
  ...
  <title>Confirm Your Subscription — Ekovibe</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;border:1px solid #E8E2D9;">
          ...
          <tr>
            <td style="background:#1C1A14;padding:40px;text-align:center;border-bottom:2px solid #C9A84C;">
              ...
              <h1 style="margin:0;font-size:28px;font-weight:800;color:#ffffff;line-height:1.2;">One tap to confirm.</h1>
              <p style="margin:16px 0 0;font-size:15px;color:#9E9892;line-height:1.6;">You're one step away from joining the inner circle.</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:40px;">
              <p style="margin:0 0 28px;font-size:15px;color:#6B6560;line-height:1.7;">
                We received your request to join <strong style="color:#1C1A14;">The Vibe List</strong> — Ekovibe's weekly drop of exclusive events, early access, and curated nightlife picks.
              </p>
              <p style="margin:0 0 28px;font-size:15px;color:#6B6560;line-height:1.7;">
                Click the button below to confirm your subscription. This link expires in <strong style="color:#1C1A14;">24 hours</strong>.
              </p>
              ...
              <p style="margin:0 0 8px;font-size:12px;color:#9E9892;line-height:1.6;">
                Or paste this link into your browser:
              </p>
              <p style="margin:0 0 28px;font-size:12px;color:#C9A84C;word-break:break-all;">
                ${confirmUrl}
              </p>

              <p style="margin:0 0 4px;font-size:13px;color:#9E9892;">If you didn't sign up for this, you can safely ignore this email.</p>
            </td>
          </tr>
