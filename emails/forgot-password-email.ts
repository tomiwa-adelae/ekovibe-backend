...
<html>
  <head>
    <meta charset="UTF-8" />
    <title>Secure Your Ekovibe Account</title>
    <style>
      body { 
    ...
    <div class="wrapper">
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Hello ${firstName}, we received a request to reset your Ekovibe account password. Use the verification code below to proceed.</p>
        ...
        <div class="footer">
          ...
          <p><a href="mailto:the9ineagency@gmail.com">Contact Security Support</a></p>
        </div>
      </div>
    </div>
  </body>
